...
/**
 * this class is to create a luxury view for mancala gam
 */
public class LuxuryView implements MancalaView {
    ...
    public LuxuryView(MancalaController controller) {
        ...
        topturn = new JLabel("<html> <font color=" + "#FFFFFF" + ">" + "P1's Turn" + "</font>");
        botturn = new JLabel("<html> <font color=" + "#FFFFFF" + ">" + "P2's Turn" + "</font>");
        ...
        String madeby = "<html> <font color=" + "#FFFFFF" + ">" + "Made by:<br>Paveen<br>Akmal<br>Amin<br>Jeflyn"
                + "</font>";
    ...
    public void stateChanged(ChangeEvent event) {
        ...
        if (model.getCurrentPlayer() == 1) {
            topturn.setText("        ");
            botturn.setText("<html> <font color=" + "#FFFFFF" + ">" + "P2's Turn" + "</font>");
        } else {
            topturn.setText("<html> <font color=" + "#FFFFFF" + ">" + "P1's Turn" + "</font>");
            botturn.setText("        ");
        }
        ...
        if (model.isDone()) {
            if (p1board[p1board.length - 1] > p2board[p2board.length - 1]) {
                JOptionPane.showMessageDialog(pits, "Player 2"
